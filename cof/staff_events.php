  ...
  <div class="dashboard clearfix">
    <ul class="tiles">
      <div class="col1 clearfix">
        ...
        <li class="tile tile-big tile-24 slideTextUp" data-page-type="no" data-page-name="no" onclick="location.href='<?=$prp_root;?>/staff_events.php';">
          <div class="fronteves" style="background-color:#cd0e13"><p>Staff Events</p></div>
          <div class="backeves" style="background-color:#cd0e13"><p><span class=""><img src="images/events_icon.png"  width="120" /></span></p></div>
        </li>     
