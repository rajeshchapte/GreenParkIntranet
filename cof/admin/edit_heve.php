...
if(isset($_REQUEST[cancel_upload])){
	header("Location: hotel_events.php");
	}
...
if(isset($_REQUEST[upload_heve])){
	...
	$vac_save = mysql_query("UPDATE  hote_staff_events SET  
							...
							WHERE id = '$heveid' AND prp_code = '$prp_id';");
          ...
          <table width="100%" border="0" cellspacing="8" cellpadding="0">        
            ...
            <tr>
              ...
              <h2>Create New Hotel Event</h2>
                <hr />
                <?php
				$sel_heve = mysql_query("SELECT * FROM hote_staff_events WHERE id = '$heveid' AND prp_code = '$prp_id'");
