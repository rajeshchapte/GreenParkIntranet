...
if(isset($_REQUEST[upload_nrs])){
	...
	$htlrevcat_id = $_POST[htlrevcat_id];
				$nrs_save = mysql_query("INSERT INTO `record_sales` (`id`, `for_m_or_d`, `recrds_date`, `record_sale_type`, `record_sale`, `lacs_or_rs`, `convertedToRs`, `hotel_revenue_cat_id`, `prp_code`, `created_datetime`) VALUES (NULL, '$for_m_or_d', '$record_date', '$record_sale_type', '$record_sale_amount', '$lacs_or_rs', '$convertedToRs', '$htlrevcat_id', '$prp_id', '$date');");
...
function validate()
{
  ...
  if( document.myForm.for_m_or_d.value == "" )
   ...
   if(document.myForm.for_m_or_d.value != "month"){
        ...
        <td width="100%">
          <table width="100%" border="0" cellspacing="8" cellpadding="0">        
            ...
            <tr>
              ...
              <h2>Add New Hotel Revenue Sales Record</h2>
              <?php if(isset($msg)): ?>
		...
		<?php endif ?>
                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                  ...
                  <tr>
                   ...
                   <td>
                      <div style="float:left">
                        <select id="htlrevcat_id" name="htlrevcat_id" class="adm_select">
                        <?php
                        ...
                        ?>  
                        <option value="<?=$htlrevcats_res[id]?>"><?=$htlrevcats_res[hotel_revenue_cat_name]?></option>
                        <?php } ?>
                        </select></div>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <div style="float:left;"><input type="text" name="record_sale_amount" id="record_sale_amount" class="adm_inptext" style="float:left"  />&nbsp;&nbsp;</div>
                        <div style="float:left;">
                        <div id="boxes">
                            <div id="Revenue">
                                  ...
                                  &nbsp;&nbsp;<select name="lacs_or_rs" class="adm_select" style="width:120px;">
                                    ...
                                    <option value="Rupees" style="width:260px;">Rupees</option>
                                    <option value="&#37;" style="width:260px;">&#37;</option>
                                    <option value="Numbers" style="width:260px;">Numbers</option>
                                  </select>  
   
                            </div>
                            <div id="Covers">
                            <?php /*?><input type="text" name="record_sale_amount" id="record_sale_amount" class="adm_inptext"  />&nbsp;&nbsp;<?php */?>
                        	</div>
                        <script type="text/javascript">
