...
if(isset($_REQUEST[upload_survey_q])){
	...
	$insert_survey_q = mysql_query("INSERT INTO `survey_questions` (`id`, `survey_id`, `survey_question_text`, `prp_code`, `created_datetime`, `created_by`) VALUES (NULL, '$sid', '$survey_question', '$prp_id', '$date', '$select_user_res[id]');");
	if($insert_survey_q){
