<div class="logo_bar" style="float:right; z-index:9; position:absolute; top:0; width:100%"> 
   <style>
...
<?php if(isset($_SESSION['user_id'])){ ?>
        <div style="width:200px; float:right; padding-right:35px;">
         ...
         <?php echo $select_emp_res[first_name]." ".$select_emp_res[last_name]; ?> </div>         
...
<?php }else{ ?>
        <div style="width:200px; float:right; padding-right:35px;">
         <div style="height:35px;  text-align:center;" class="show_hide"  onclick="location.href='login.php';"><a href="login.php">Log In</a>
         <?php echo $select_emp_res[first_name]." ".$select_emp_res[last_name]; ?> </div>         
