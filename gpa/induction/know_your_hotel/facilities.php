    ...
    <div class="dashboard clearfix">
        <ul class="tiles">
          ...
          <div class="col2 clearfix">
            ...
            <li class="tile tile-small tile-17 slideTextLeft" data-page-type="no" data-page-name="no"  onclick="location.href='facilities/tariff_p.php';">
        ...
        <li class="tile tile-small last tile-7  slideTextLeft" data-page-type="r-page" data-page-name="random-r-page"  onclick="location.href='facilities/facilities.php';">
          ...
          <div class="col3 clearfix">
            ...
            <li class="tile tile-small tile-17 slideTextLeft" data-page-type="no" data-page-name="no"  onclick="location.href='facilities/service.php';">
        ...
        <li class="tile tile-small last tile-17 slideTextLeft" data-page-type="r-page" data-page-name="random-r-page"  onclick="location.href='facilities/contactus.php';">
