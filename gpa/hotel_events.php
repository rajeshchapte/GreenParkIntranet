  ...
  <div class="dashboard clearfix">
    <ul class="tiles">
      <div class="col1 clearfix">
        ...
        <li class="tile tile-big last tile-24 rotate3d rotate3dX" data-page-type="no" data-page-name="no"  onclick="location.href='<?=$prp_root;?>/hotel_events.php';">
          <div class="faces">
            <div class="frontheves"><p align="center" class="inner">Hotel Events</p></div>
            <div class="backheves" style="pading-top:20px;"><img src="images/events_icon.png"  width="130" /></div>
          </div>
        </li>
              ...
              <h2>Hotel Events</h2>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#CCCCCC">
                  ...
                  <tr bgcolor="#ececef" height="35">
                    <td width="20%">
                    <a href="hotel_event_desc.php?heveid=<?=$hevsres[id];?>&prp_code=<?=$prp_id;?>"><?php echo $hevsres[event_title]; ?></a></td>
