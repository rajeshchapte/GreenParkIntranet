...
if(isset($_REQUEST[save_dept])){
	...
	$dept_add = mysql_query("INSERT INTO department (`id`, `department_name`, `department_description`, `crated_datetime`) VALUES (NULL, '$dept_name', '$dept_desc','$date');");
            ...
            <tr>
              <td width="33%" valign="top"> 
                ...
                <table width="100%" height="280" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                  <td onclick="location.href='<?=$prp_root;?>/departments.php';" class="color19" height="136">
                    <div class="tile_box">
              ...
              <h2>Create New Department</h2>
                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                  <tr>
                    <td width="20%">Department Name</td><td><input type="text" name="dept_name" id="dept_name" class="adm_inptext"  /></td>
                  </tr>
                  <tr>
                    <td width="20%">Description</td><td><input type="text" name="dept_desc" id="dept_desc" class="adm_inptext"  /></td>
                  </tr>
                  <tr>
