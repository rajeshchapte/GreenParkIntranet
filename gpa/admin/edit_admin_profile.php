...
if(isset($_REQUEST[cancel_upload])){
	header("Location: gp_admin_profile.php");
	}
...
//		{
			...
			$gender = $_POST[gender];
				...
				$inserUser = mysql_query("UPDATE gp_user SET `first_name` =  '$first_name',
										...
										`password` =  '$password',
										`dob` =  '$birth_date',
										`gender` =  '$gender' WHERE  id = '$select_user_res[id]' AND property_code = '$prp_id'" );
          ...
          <table width="100%" border="0" cellspacing="8" cellpadding="0">        
            ...
            <tr>
              ...
              <h2>Edit User Details</h2>
                <hr />
                <?php
				  $user =  mysql_query("SELECT * FROM gp_user WHERE property_code = '$prp_id' AND id = '$select_user_res[id]'");
