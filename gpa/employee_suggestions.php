...
if(isset($_REQUEST[cancel_sgtns])){
...
if(isset($_REQUEST[upload_sgtns])){
	
	$si_type = $_POST[si_type];
	...
	$sgtns_save = mysql_query("INSERT INTO employee_suggestions (`id`, `prp_code`, `type`, `suggester_user_id`, `suggestion_title`, `suggestion_description`,`departmentid`,  `created_datetime`) VALUES (NULL, '$prp_id', '$si_type', '$_SESSION[user_id]', '$suggestion_title', '$suggestion_desc', '$emp_dept',  '$date');");

		if($sgtns_save){ 
		
		    $to  = 'HR Corp <jawed@marigoldhotels.com>';//
  ...
  <div class="dashboard clearfix">
    <ul class="tiles">
      <div class="col1 clearfix">
        ...
        <li class="tile tile-big tile-25 slideTextLeft" data-page-type="no" data-page-name="no" onclick="location.href='<?=$prp_root;?>/employee_suggestions.php';">
          <div>
            <p style="font-size:18px;">Suggestions,<br>
              Idea Box</p>
          </div>
          <div>
            <p><span class=""><img src="images/suggestion_icon.png"  width="100" /></span></p>
          </div>
        </li>
      </div>
      ...
      <div class="col4 clearfix">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <h2>Employee Suggestions/Idea</h2>
                <hr />
                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                  <tr>
                    <td>Suggestions/Idea</td>
                    <td>
                      <select name="si_type" class="adm_select" style="width:">
                  ...
                  <tr>
                    <td width="20%">Employee Suggestions/Idea</td><td><input type="text" name="suggestion_title" id="suggestion_title" class="adm_inptext"  /></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td width="20%" valign="top">Suggestion/Idea Description</td><td>
                      <textarea name="suggestion_desc" style="height:150px; width:100%"></textarea>
                    </td>
                  </tr>
                 
                    <td>&nbsp;</td><td align="right"><br />
                    <input type="submit" class="ubutton" name="upload_sgtns" value="Save" />&nbsp;&nbsp;&nbsp;
                    <input type="submit" class="ubutton" name="cancel_sgtns" value="Cancel" /></td>
                  </tr>
                </table>
