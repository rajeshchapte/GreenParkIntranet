      ...
      <tr>
		...
		?>
                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                  ...
                  <?php /*?><tr>
                    <td width="20%">Room Revenue</td>
                    <td><input type="text" name="room_revenue" id="room_revenue" class="adm_inptext" value="<?php echo $sel_rs_res[room_revenue];?>" /></td>
                  </tr>
                  <tr>
                    <td width="20%">Room Nights Sold</td>
                    <td><input type="text" name="room_nights_sold" id="room_nights_sold" class="adm_inptext"  value="<?php echo $sel_rs_res[room_nights_sold];?>" /></td>
                  </tr>
                  <tr>
                    <td width="20%">Occupancy Percentage</td>
                    <td><input type="text" name="occupancy_percentage" id="occupancy_percentage" class="adm_inptext"  value="<?php echo $sel_rs_res[occupancy_percentage];?>" /></td>
                  </tr>
                  <tr>
                    <td width="20%">ARR</td>
                    <td><input type="text" name="arr" id="arr" class="adm_inptext"  value="<?php echo $sel_rs_res[arr];?>" /></td>
                  </tr>
                  <tr>
                    <td width="20%">Laundry Revenue</td>
                    <td><input type="text" name="laundry_revenue" id="laundry_revenue" class="adm_inptext"  value="<?php echo $sel_rs_res[laundry_revenue];?>" /></td>
                  </tr><?php */?>
