...
$itemid = $_GET[itemid];
$select_merchandize = mysql_query("SELECT * FROM merchandize WHERE id = '$itemid'");
$smres = mysql_fetch_array($select_merchandize);
	...
	if( $_FILES['item_image']['name'] != ''){
			...
			if(isset($files)){
					foreach ($files as $image) {
						$item_save = mysql_query("UPDATE  merchandize SET  `item_name` =  '$item_name',
												`item_desc` =  '$item_desc',
												`item_price` =  '$item_price',
												`item_image` =  '$image' WHERE  id = '$itemid';");
							if($item_save){
                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                  <tr>
                     <td width="20%">Item Name</td><td>
                       <input type="text" name="item_name" id="item_name" class="adm_inptext" value="<?=$smres[item_name];?>" />
                     </td>
                  </tr>
                  <tr>
                    <td width="20%">Item Description</td><td><input type="text" name="item_desc" id="item_desc" class="adm_inptext" value="<?=$smres[item_desc];?>" /></td>
                  </tr>
                  <tr>
                    <td width="20%">Item Price</td><td>
                      <input type="text" name="item_price" id="item_price" class="adm_inptext" value="<?=$smres[item_price];?>" />
                    </td>
                  </tr>
                  <tr>
                    <td width="20%">Item Image</td><td>
					  <img src="<?=$smres[item_image];?>" width="140px" /><br /> 
