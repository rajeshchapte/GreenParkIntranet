...
if(isset($_REQUEST[upload_cftm])){
	...
	//$vac_save = mysql_query("INSERT INTO `cafeteria_menu` (`id`, `menu_date`, `menu_non_veg_items`, `menu_veg_items`, `menu_drinks_fruits`, `thought_of_day`, `created_datetime`,  `prp_code`) VALUES (NULL, '$menu_date', '$menu_non_veg_items', '$menu_veg_items', '$drinks_and_fruits', '$thought_of_day', '$date', '$prp_id');");
				...
				$vac_save = mysql_query("UPDATE  cafeteria_menu SET  
				`menu_date` =  '$menu_date',
				`menu_non_veg_items` =  '$menu_non_veg_items',
				`menu_veg_items` =  '$menu_veg_items',
				`menu_drinks_fruits` =  '$drinks_and_fruits',
...
$sel_cftm = mysql_query("SELECT * FROM cafeteria_menu WHERE id = $cftmid");
$res_cftm = mysql_fetch_array($sel_cftm);
        ...
        <td width="100%">
          <table width="100%" border="0" cellspacing="8" cellpadding="0">        
            ...
            <tr>
              ...
              <h2>Edit Cafeteria Menu</h2>
                <hr />
                <form id="form1" name="myForm" method="POST" action="" enctype="multipart/form-data" >   
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                  <tr>
                    <td width="20%">Menu Date</td><td>
                      <input type="text" name="menu_date" id="menu_date" class="adm_inptext" value="<?php echo date('m/d/Y',strtotime($res_cftm[menu_date]));?>" /><br />
                      <?php if($error_msg != ''){
                  ...
                  <tr>
                    <td width="20%">Non Veg Items</td><td><input type="text" name="menu_non_veg_items" id="menu_non_veg_items" class="adm_inptext" value="<?=$res_cftm[menu_non_veg_items];?>"  /></td>
                  </tr>
                  <tr>
                    <td width="20%">Veg Items</td><td>
                      <input type="text" name="menu_veg_items" id="menu_veg_items" class="adm_inptext" value="<?=$res_cftm[menu_veg_items];?>"  />
                    </td>
                  </tr>
                  <tr>
                    <td width="20%">Drinks And Friuts</td><td>
                      <input type="text" name="drinks_and_fruits" id="drinks_and_fruits" class="adm_inptext"  value="<?=$res_cftm[menu_drinks_fruits];?>" />
                    </td>
                  </tr>
                  <tr>
                    <td width="20%">Thought Of The Day</td><td>
                      <input type="text" name="thought_of_day" id="thought_of_day" class="adm_inptext"  value="<?=$res_cftm[thought_of_day];?>" />
                    </td>
                  </tr>
                  <tr>
