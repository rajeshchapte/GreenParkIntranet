                                  ...
                                  <div class="TabbedPanelsContentGroup">
                                    <div class="TabbedPanelsContent"><table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#CCCCCC">
                                          <tr bgcolor="#999999" height="25"><td><strong>S. No</strong></td><td><strong>Record Date</strong></td><td><strong>Record Amount</strong></td></tr>
                                                          ...
                                                          $i = 1;
                                                          $rs =  mysql_query("SELECT * FROM record_sales WHERE prp_code = '$prp_id' AND for_m_or_d = '$mdtype' AND hotel_revenue_cat_id NOT IN (1) ORDER BY convertedToRs DESC LIMIT 0, 10");
                                                          ...
                                                          <tr bgcolor="#FFFFFF">
                                                            ...
                                                            <td width="24%" style="text-transform:capitalize"><?php if($rsres[record_sale]!='0'){ ?> &#8377;&nbsp;<?=$rsres[record_sale]." ".$rsres[lacs_or_rs]; } ?></td>
...
<?php /*?><table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#CCCCCC">
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#CCCCCC">
          <tr bgcolor="#999999" height="25"><td><strong>S. No</strong></td><td style="padding:0 0 0 10px"><strong>Record Date</strong></td><td style="padding:0 0 0 10px"><strong>Record Information</strong></td></tr>
                          ...
                          $i = 1;
                          $rs =  mysql_query("SELECT * FROM record_sales_fo WHERE prp_code = '$prp_id' AND for_m_or_d = '$mdtype' ORDER BY convertedToRs DESC LIMIT 0 , 10");
                                while($rsres = mysql_fetch_array($rs)){
                          ...
                          <tr bgcolor="#FFFFFF">
                            ...
                            <td width="34%" style="font-size:12px; padding:0 0 0 10px">
                              <?php echo fo_servcat("$rsres[fo_servcat_id]").": &#8377;&nbsp;".$rsres[fo_record_amount]." ".$rsres[lacs_or_rs]; ?> 
                            </td>
