  ...
  <div class="dashboard clearfix">
    <ul class="tiles">
      <div class="col1 clearfix">
        ...
        <li class="tile tile-big last tile-2  slideTextRight" data-page-type="no" data-page-name="no" onclick="location.href='documented_sop.php';">
          <div style="margin-top:0px;">
            <p><img src="images/sop_icon.png" width="130" /></p>
          </div>
          <div style="background-color:#007e00; color:#FFFFFF;" class="tiletextfont">
            <p>Documented SOP's</p>
          </div>
        </li>
      </div>
      ...
      <div class="col4 clearfix" style="background-color:#003e00; padding:16px 0px 0px 0px; margin:0px;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <?php
						$sops =  mysql_query("SELECT * FROM sops WHERE sop_type = 'documented'");
					    while($sopsres = mysql_fetch_array($sops)){
							$soppdf = $sopsres[soppdf_title];
							//$soppdf = str_replace("_"," ",$soppdf);
						?>
                            <li class="tile tile-dsmall slideTextLeft" data-page-type="no" data-page-name="no" onclick="window.open('/admin/sopfiles/<?=$sopsres[file_location];?>', 'popUpWindow', 'height=650, width=1100, left=50, top=50, resizable=yes, scrollbars=yes, toolbar=yes, menubar=no, location=no, directories=no, status=yes');" style="margin: 0px 7px 4px 0px;">
