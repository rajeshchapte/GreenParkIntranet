  ...
  <div class="dashboard clearfix">
        <ul class="tiles">
          ...
          <div class="col4 clearfix">
          		...
          		<h2 style="color:#000000;">C Off Declaration</h2>
                <hr />
               <div>
	        	
<form action="C-Off-Declaration_pp.php" method="get" target="POPUPW" onsubmit="POPUPW = window.open('about:blank','POPUPW', 'height=550,width=1000,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');" enctype="multipart/form-data" >
    ...
    <td width="150%" height="25" align="center" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td height="25" align="left"><span style="word-spacing: 0pt; text-indent: 0pt; line-height: 150%; margin: 0pt;">
          <input name="T2" size="30" maxlength="30" onkeyup='Fchang(this,&quot;T3&quot;)' type="text" id="declarationdate" />
          </span></td>
        </tr>
      <tr>
      ...
      <tr>
        <td height="25" align="left">Date of Compensatory Off</td>
        <td align="center" valign="middle">:</td>
        <td height="25" align="left"><span style="word-spacing: 0pt; text-indent: 0pt; line-height: 150%; margin: 0pt;">
          <input name="T5" size="30" maxlength="30" onkeyup='Fchang(this,&quot;T5&quot;)' type="text" id="compensatorydate" />
        </span></td>
        </tr>
      <tr>
        <td height="25" align="left">Reason for Compensatory Off</td>
        <td align="center" valign="middle">:</td>
        <td height="25" align="left"><span style="word-spacing: 0pt; text-indent: 0pt; line-height: 150%; margin: 0pt;">
          <input name="T6" size="30" maxlength="30" onkeyup='Fchang(this,&quot;T5&quot;)' type="text" id="reasindate" />
        </span></td>
        </tr>
      <tr>
      ...
      <tr>
        <td height="25" colspan="3" align="left">Note: Must be submitted to Personnel Department one day advance.</td>
        </tr>
      <tr>
      ...
      <tr>
        ...
        <td height="25" align="left"><b>
          <input value="Print Preview" name="PRNVEW" type="submit"  class="ubutton"/>
          </b></td>
        </tr>
      </table></td>
  </tr>
