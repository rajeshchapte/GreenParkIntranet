  ...
  <div class="dashboard clearfix">
        <ul class="tiles">
          ...
          <div class="col4 clearfix">
           			 ...
           			 <h2 style="color:#000000;">EDUCATION SCHOLARSHIP FORM</h2>
                <hr />
               <div>
	        	

<form action="EDUCATION_SCHOLARSHIP_FORM_pp.php" method="get" target="POPUPW" onsubmit="POPUPW = window.open('about:blank','POPUPW', 'height=550,width=1000,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');" enctype="multipart/form-data" >
...
<p style="word-spacing: 0pt; text-indent: 0pt; line-height: 100%; margin: 0pt;" align="center"><b>
 EDUCATION SCHOLARSHIP FORM</b></p>
  ...
  <tr>
    <td width="150%" height="25" align="center" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="44%" height="25" align="left">EMPLOYEE NAME</td>
      ...
      <tr>
        ...
        <td align="center" valign="middle">:</td>
        <td height="25" align="left"><span style="word-spacing: 0pt; text-indent: 0pt; line-height: 150%; margin: 0pt;">
          <input name="T5" size="30" maxlength="30" onkeyup='Fchang(this,&quot;T3&quot;)' type="text" />
        </span></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="25" colspan="2" align="left"><strong>IN CASE OF CHILDREN</strong></td>
        <td align="center" valign="middle">&nbsp;</td>
      ...
      <tr>
        <td height="25" colspan="4" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="42%" height="25" align="left" valign="middle">NAME</td>
            <td width="54%" height="25" align="left" valign="middle">CLASS</td>
          </tr>
          <tr>
      ...
      <tr>
        <td height="25" colspan="4" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="25" align="left">Total amount of Claim( children and Self together) Rs.<span style="word-spacing: 0pt; text-indent: 0pt; line-height: 150%; margin: 0pt;">
              <input name="T11" size="30" maxlength="30" onkeyup='Fchang(this,&quot;T3&quot;)' type="text" />
            </span></td>
          </tr>
          <tr>
            <td height="25" align="left">(Rupees	<span style="word-spacing: 0pt; text-indent: 0pt; line-height: 150%; margin: 0pt;">
