                    ...
                    <td>
                        ...
                        <div id="boxes">
                            <div id="Revenue">
                                ...
                                <input type="text" name="record_sale_amount" id="record_sale_amount" class="adm_inptext" style="float:left"  />&nbsp;&nbsp;
                                  ...
                                  <script type="text/javascript" src="path/to/jquery.js"></script>
                                    <script type="text/javascript">
                                    //alert(document.getElementById("thechoices1").value);
                                    function changeval(){
                            ...
                            <div id="Covers">
                            <input type="text" name="record_sale_amount" id="record_sale_amount" class="adm_inptext"  />&nbsp;&nbsp;
                        </div>
                        <script type="text/javascript">
