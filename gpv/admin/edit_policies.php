...
$polc =  mysql_query("SELECT * FROM policies WHERE id = $polc_id");
$polc = mysql_fetch_array($polc);

$polc_cate_res = mysql_query("SELECT * FROM policy_categories WHERE id = $polc[policy_caregotry_id]");
$polc_cate_res1 = mysql_fetch_array($polc_cate_res);


if(isset($_REQUEST[update_polc])){
	...
	//echo $polc_text;
	$polc = mysql_query("UPDATE  policies SET
	`policy_caregotry_id` = '$polc_category', 
	`policy_title` = '$polc_title', 
	`policy_text` = '$polc_text' WHERE id = '$polc_id';");
          ...
          <table width="100%" border="0" cellspacing="8" cellpadding="0">        
            ...
            <tr>
              ...
              <h2>Create New policy</h2>
                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                  <tr>
                    <td width="20%">Policy Title</td><td><input type="text" name="polc_title" id="polc_title" class="adm_inptext" value="<?=$polc[policy_title]; ?>"  /></td>
                  </tr>
                  <tr>
                    ...
                    <select name="polc_category" class="adm_select">
                      <option value="<?=$polc_cate_res1[id]?>"><?=$polc_cate_res1[policy_category]?></option>
                    </select></div>
			...
			CKEDITOR.replace( 'editor1', {
				on: {
                  ...
                  <tr>
                    <td>&nbsp;</td><td align="right"><br /><input type="submit" class="ubutton" name="update_polc" value="Save" />&nbsp;&nbsp;&nbsp;
