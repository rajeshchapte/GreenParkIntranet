...
if(isset($_REQUEST[upload_ancs])){
	...
	$ancs_save = mysql_query("INSERT INTO `announcements` (`id`, `announcement`, `announcement_desc`, `departmentid`, `prp_code`, `created_datetime`) VALUES (NULL, '$announcement_name', '$announcement_desc', NULL, '$prp_id', '$date');");
