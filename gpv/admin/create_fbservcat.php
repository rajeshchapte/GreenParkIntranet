...
if(isset($_REQUEST[save_fbservcat])){
	...
	$fbservcat_add = mysql_query("INSERT INTO fb_services_cats (`id`, `fb_serivces_cat_name`, `fb_serivces_cat_desc`, `prp_code`, `created_datetime`) VALUES (NULL, '$fbservcat_name', '$fbservcat_desc', '$prp_id', '$date');");
		if($fbservcat_add){ 
		echo "done";
		header("Location: ".$_GET[purl]);
		}
...
function validate()
{
  ...
  if( document.myForm.fbservcat_name.value == "" )
   {
     alert( "Please provide F & B Service Name" );
            ...
            <tr>
              ...
              <h2>Create New F &amp; B Service</h2>
                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                  <tr>
                    <td width="20%">F &amp; B Service Name</td><td><input type="text" name="fbservcat_name" id="fbservcat_name" class="adm_inptext"  /></td>
                  </tr>
                  <tr>
                    <td width="20%">Description</td><td><input type="text" name="fbservcat_desc" id="fbservcat_desc" class="adm_inptext"  /></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td><td align="right"><br /><input type="submit" class="ubutton" name="save_fbservcat" value="Save"  onclick="return(validate());"  />&nbsp;&nbsp;&nbsp;
