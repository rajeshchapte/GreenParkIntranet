...
if(isset($_REQUEST[upload_book])){
	...
	$vac_save = mysql_query("INSERT INTO `library_information` (`id`, `prp_code`, `book_code`, `book_name`, `author_name`, `book_price`, `book_category_id`, `created_datetime`) VALUES (NULL, '$prp_id', '$book_code', '$book_name', '$author_name', '$book_price', '$book_cate', '$date');");
            ...
            <tr>
              ...
              <h2>Add New Book</h2>
                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                  <tr>
                     <td width="20%">Book Category</td><td>
                       ...
                       <select name="book_cate" class="adm_select">
                        ...
                        ?>  
                        <option value="<?=$bcatres[id]?>"><?=$bcatres[book_category_name]?></option>
                        <?php } ?>
                        </select></div>
                  ...
                  <tr>
                    <td width="20%">Book Code</td><td><input type="text" name="book_code" id="book_code" class="adm_inptext"  /></td>
                  </tr>
                  <tr>
                    <td width="20%">Book Name</td><td>
                      <input type="text" name="book_name" id="book_name" class="adm_inptext"  />
                    </td>
                  </tr>
                  <tr>
                    <td width="20%">Author Name</td><td>
                      <input type="text" name="author_name" id="author_name" class="adm_inptext"  /> 
                    </td>
                  </tr>
                  <tr>
                    <td width="20%">Book Price</td><td>                      
                       <input type="text" name="book_price" id="book_price" class="adm_inptext"  />                     
                    </td>
                  </tr>
