          ...
          <div class="col1 clearfix">
           ...
           <div class="col4 clearfix">
             ...
             <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tbody>
                      <tr>
                        <td class="BodyText" scope="row" height="45" align="left" valign="top"><p align="center"><img src="../images/VIZAG_location.gif" alt="Hotel GreenPark Hyderabad" height="221" border="0" width="446"></p>
                          <p>Situated in Waltair main road, Visakhapatnam, at a close proximity 2 km from Railway Station, a 5 minutes drive from the Business and Shopping Centre, 14 kms from the Airport.</p></td>
                      </tr>
                      <tr>
                        <th class="headingBlack" scope="row" height="25" align="left" valign="top"><p><span class="style1">Distance </span>:</p>
                          <table style="border-collapse:collapse; font-weight:normal;" align="left" border="1" bordercolor="#666666" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tbody>
                              <tr>
                                <td align="left" valign="middle" class="BodyText" scope="row">Airport</td>
                                <td class="BodyText" scope="row" height="25" align="right">12 Kms.</td>
                              </tr>
                              <tr>
                                <td align="left" valign="middle" class="BodyText" scope="row">Visakhapatnam Railway Station</td>
                              <td class="BodyText" scope="row" height="25" align="right">02 Kms.</td>
                              </tr>
                              <tr>
                                <td align="left" valign="middle" class="BodyText" scope="row">Shopping / Commercial Area</td>
                                <td class="BodyText" scope="row" height="25" align="right">01 Kms.</td>
                              </tr>
                            </tbody>
                          </table>
