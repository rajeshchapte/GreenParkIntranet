...
xmlhttp.open("GET","moveknydown.php?knyupid="+str,true);
xmlhttp.send();
}

function moveKymUp(str)
{
if (str=="")
  {
  document.getElementById("userRequestinfoDiv"+str).innerHTML="";
...
xmlhttp.open("GET","moveknyup.php?knyupid="+str,true);
xmlhttp.send();
}
          ...
          <table width="100%" border="0" cellspacing="8" cellpadding="0">        
            ...
            <tr>
              ...
              <h2>Know Your Managers</h2>
                <hr />
<script type="text/javascript">
    function MoveDown(roww,rowwN,strorder)
    { 
      ...
      { 
		...
		moveKymDown(strorder);
      }
    }
    function MoveUp(roww,rowwN,strorder)
    { 
      divv = document.getElementById(roww+'R').innerHTML;
      if(roww)
      { 
				  ...
				  ?> 
					...
					<div id="D<?php echo $c; ?>R">
                      <div style="float:left"> 
                        ...
                        echo $kymres[m_designation]; echo ", "; 
						if($kymres[m_department]!='0'){ echo dept_name($kymres[m_department]); } 
                        echo "<br>";
                      ...
                      <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>" name="delete_kym_form">
                        <input type="hidden" name="kymid" value="<?php echo $kymres[id] ?>"  />                        
                      ...
                      <form method="get" action="edit_manager.php" name="edit_kym_form">
                        <input type="hidden" name="mid" value="<?php echo $kymres[id] ?>"  />                        
                      ...
                      <div id="userRequestinfoDiv<?php echo $kymres[id]; ?>" style="clear:both; float:left"></div>
                      <div style="float:right">
                       <input type="image" src="images/up_icon.png" title="Move Up" style="width:20px;" id="U<?php echo $c; ?>" value="Up" class="move up"  onClick="MoveUp('D<?php echo $c; ?>','D<?php echo $c-1; ?>','<?php echo $kymres[id]; ?>');"/>
                       <input type="image" src="images/down_icon.png" title="Move Down" style="width:20px;" id="D<?php echo $c; ?>" value="Down" class="move down"  onClick="MoveDown('D<?php echo $c; ?>','D<?php echo $c+1; ?>','<?php echo $kymres[id]; ?>');"/>
                       </div>
                      </div>
                      </td>
                      </tr>
