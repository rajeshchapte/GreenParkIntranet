...
if(isset($_REQUEST[delete_heve])){
	$heveid = $_POST[heveid];
	$delheve = mysql_query("DELETE FROM hote_staff_events WHERE id = '$heveid'");
	if($delheve){
		$delmsg = "Hotel Event Deleted";
		//unlink($somefile);
	}else{
		$delmsg = "Fail";
	}
            ...
            <tr>
              ...
              <h2>Hotel Events</h2>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#CCCCCC">
                  ...
                  <?php
				  $i = 1;
				  $hevs =  mysql_query("SELECT * FROM hote_staff_events WHERE prp_code = $prp_id AND event_type = 'Hotel Event' ORDER BY event_datetime DESC");
                  ...
                  <tr bgcolor="#ececef">
                    ...
                    <td width="18%" align="right">
                      ...
                      <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>" name="delete_empf">
                        ...
                        <input type="submit" name="delete_heve" value="Delete" class="ubutton" onclick="return confirm('Are you sure want to delete?');" />
                      </form></div>
                      
                      <div style="float:right"><form method="get" action="edit_heve.php" name="edit_emp">
                        <input type="hidden" name="heveid" value="<?php echo $hevsres[id] ?>"  />                        
                  ...
                  <input type="button" onclick="location.href='create_hotel_event.php';"  class="ubutton" value="New Hotel Event" />
