...
if(isset($_REQUEST[upload_sop])){
	...
	//$changepropic = mysql_query("INSERT INTO document (`id`, `document_name`, `doc_file`, `user_id`, `sales_force_document_id`, `sales_force_account_id`, `sync`, `verified`) VALUES (NULL, '$doc_title', '$nfile', '$uid', NULL, NULL, '0', '0');");
	
	$changepropic = mysql_query("INSERT INTO sops (`id`, `sop_type`, `soppdf_title`, `file_location`, `created_datetime`) VALUES (NULL, '$sop_type', '$sop_title', '$rfile', '');");
