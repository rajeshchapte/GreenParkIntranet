            ...
            <tr>
              ...
              <h2>User's</h2>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#CCCCCC">
                  ...
                  <?php /*?><td><strong>Picture</strong></td><?php */?>
                  <td><strong>Action</strong></td></tr>
                  <?php
				  
				  $i = 1;
				  $emps =  mysql_query("SELECT * FROM gp_user WHERE role = 'hr'");
                  ...
                  <tr bgcolor="#ececef">
                    ...
                    <td width="18%">
                    <?php echo get_prp_name($empsres[property_code]); ?>
                    </td>
                    <?php /*?><td width="8%" align="center">
                    ...
                    <td width="15%" align="right">
                      ...
                      <?php /*?><form method="post" action="active_deactive_gpuser.php" name="delete_empf">
