...
if(isset($_REQUEST[delete_sop])){
	...
	$delsopfile = mysql_query("DELETE FROM sops WHERE id = $sopdelid and sop_type = 'documented'");
	if($delsopfile){
            ...
            <tr>
              <td width="33%" valign="top"> 
                ...
                <table width="100%" height="280" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                  <td onclick="location.href='<?=$admin_home;?>/documented_sop.php';" class="color1" height="136">
                    <div class="tile_box">
                    <div align="center" style="top:10px; position:relative"><img src="images/sop_icon.png"  width="100" /></div>
                      <div class="tile_name">
                      Documented SOP's
              ...
              <h2>SOP's</h2>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#CCCCCC">
                  ...
                  <tr bgcolor="#ececef">
                    ...
                    <td width="80%" style="text-transform:capitalize"><a style="cursor:pointer;" onclick="window.open('sopfiles/<?=$sopsres[file_location];?>', 'popUpWindow', 'height=700, width=1100, left=100, top=100, resizable=yes, scrollbars=yes, toolbar=yes, menubar=no, location=no, directories=no, status=yes');"><?=$soppdf;?></a></td>
                    <td width="15%" align="right">
                     ...
                     <div style="float:right">
                      ...
                      <div style="float:right"><form method="get" action="edit_sop.php" name="edit_emp">
                        <input type="hidden" name="sopid" value="<?php echo $sopsres[id] ?>"  />
                        <input type="hidden" name="sop_type" value="documented"  />               
                ...
                <form method="post" action="upload_dsopfile.php" >
                <input type="hidden" name="sop_type" value="documented"  />
