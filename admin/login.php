...
$rowsettings = mysql_fetch_array($resultsettings);
	...
	{
		$sqlLogin = "SELECT * from gp_user WHERE email_id='".mysql_real_escape_string(strtolower($_POST['user_id']))."' AND password='".mysql_real_escape_string($pass)."' AND role='admin'" ;
            ...
            <tr>
              <td width="33%" valign="top"> 
                ...
                <table width="100%" height="280" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr height="136">
                    <td onclick="location.href='<?=$admin_home;?>/';" class="color1" height="136">
                    <div class="tile_box">
