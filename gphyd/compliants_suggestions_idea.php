  ...
  <div class="dashboard clearfix">
    <ul class="tiles">
      <div class="col1 clearfix">
        ...
        <li class="tile tile-big tile-28 slideTextLeft" data-page-type="no" data-page-name="no" onclick="location.href='<?=$prp_root;?>/compliants_suggestions_idea.php';">
          <div>
      ...
      <div class="col4 clearfix">
        ...
        <li class="tile tile-dsmall tile-28 slideTextLeft" data-page-type="no" data-page-name="no" onclick="location.href='<?=$prp_root;?>/employee_complaints.php';">
          <div>
        ...
        <li class="tile tile-dsmall tile-28 slideTextLeft" data-page-type="no" data-page-name="no" onclick="location.href='<?=$prp_root;?>/employee_suggestions.php';">
          <div>
            <p style="font-size:18px;">Suggestions,<br>Idea Box</p>
          </div>
          <div>
            <p><span class=""><img src="images/suggestion_icon.png"  width="100" /></span></p>
          </div>
