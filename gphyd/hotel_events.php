  ...
  <div class="dashboard clearfix">
    <ul class="tiles">
      <div class="col1 clearfix">
        ...
        <li class="tile tile-big tile-14 slideTextRight" data-page-type="no" data-page-name="no" onclick="location.href='<?=$prp_root;?>/hotel_events.php';">
          <div><p><span class=""><img src="images/events_icon.png"  width="120" /></span></p></div>
          <div><p>Hotel Events</p></div>
        </li>
