                  ...
                  <tr>
                    <td>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <li class="tile tile-dsmall tile-18 slideTextRight" data-page-type="no" data-page-name="no"  onclick="location.href='<?=$prp_root;?>/hotel_awards.php';">
                          <div><img src="images/award_icon.png"  width="125"  style="margin-top:20px;"/></div>        
                          <div><p>Hotel Awards</p></div> 
                        </li>
                        <li class="tile tile-dsmall tile-18 slideTextRight" data-page-type="no" data-page-name="no"  onclick="location.href='<?=$prp_root;?>/staff_awards.php';">
                          <div><img src="images/award_icon.png"  width="125"  style="margin-top:20px;"/></div>        
