...
if(isset($_REQUEST[upload_emp])){
	...
	$max_file_size = 1024*2048;
				...
				$rfile= base64_encode("emppic_".$fist_name."_".$birth_date); //To get the name of the image
				...
				$emp_save = mysql_query("INSERT INTO `employee_directory` (`id`, `emp_id`, `first_name`, `last_name`, `gender`, `email_id`, `contact_number`, `address`, `birth_date`, `joining_date`, `designation`, `emp_pic`, `created_datetime`, `modified_datetime`, `departmentid`, `prp_code`) VALUES (NULL, '$emp_id', '$fist_name', '$last_name', '$gender', '$email_id', '$mobile_no', '$address', '$birth_date', '$joining_date', '$designation', '$profile_pic', '$date', '$date', '$emp_dept', '$prp_id');");
...
function validate()
{
   ...
   {
   	var regex = /^[0-9]{10,15}$/;
	var mobile = document.myForm.emp_id;
            ...
            <tr>
              ...
              <h2>Create New Employee</h2>
                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                  <tr>
                    <td width="20%">Employee ID</td><td><input type="text" name="emp_id" id="emp_id" class="adm_inptext"  /></td>
                  </tr>
                  <tr>
