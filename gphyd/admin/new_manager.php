...
$selectmaxid = mysql_query("SELECT id,MAX(id) as mid FROM know_your_managers");
$selectmaxid_res = mysql_fetch_array($selectmaxid);
$maxid = $selectmaxid_res[mid]+1;
...
if(isset($_REQUEST[upload_kym])){
	...
	if(isset($files)){
			foreach ($files as $image) {
				...
				$kny_save = mysql_query("INSERT INTO know_your_managers (`id`, `m_first_name`, `m_last_name`, `m_email`, `m_mobile`, `m_phone`, `m_phone_extn`, `m_fax`, `m_department`, `m_designation`, `m_pic`, `sort_oreder`, `prp_code`, `created_datetime`) VALUES (NULL, '$m_first_name', '$m_last_name', '$m_email', '$m_mobile', '$m_phone', NULL, NULL, '$m_department', '$m_designation', '$image', '$maxid', '$prp_id', '$date');");
				...
				$kny_save = mysql_query("INSERT INTO know_your_managers (`id`, `m_first_name`, `m_last_name`, `m_email`, `m_mobile`, `m_phone`, `m_phone_extn`, `m_fax`, `m_department`, `m_designation`, `m_pic`, `sort_oreder`, `prp_code`, `created_datetime`) VALUES (NULL, '$m_first_name', '$m_last_name', '$m_email', '$m_mobile', '$m_phone', '$m_phone_extn', '$m_fax', '$m_department', '$m_designation', NULL, '$maxid', '$prp_id', '$date');");
                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                  <tr>
                     <td width="20%">First Name</td><td>
                       <input type="text" name="m_first_name" id="m_first_name" class="adm_inptext"  />
                     </td>
                  </tr>
                  <tr>
                     <td width="20%">Last Name</td><td>
                       <input type="text" name="m_last_name" id="m_last_name" class="adm_inptext"  />
                     </td>
                  </tr>
                  <tr>
                     <td width="20%">Email Id</td><td>
                       <input type="text" name="m_email" id="m_email" class="adm_inptext"  />
                     </td>
                  </tr>
                  <tr>
                     <td width="20%">Mobile</td><td>
                       <input type="text" name="m_mobile" id="m_mobile" class="adm_inptext" />
                     </td>
                  </tr>
                  <tr>
                     <td width="20%">Phone</td><td>
                       <input type="text" name="m_phone" id="m_phone" class="adm_inptext"  /><?php /*?>&nbsp;&nbsp;-&nbsp;&nbsp;<input type="text" name="m_phone_extn" id="m_phone_extn" class="adm_inptext" style="width:60px;"   /><?php */?>
                     </td>
                  </tr>
                  <?php /*?><tr>
                     <td width="20%">Fax</td><td>
                       <input type="text" name="m_fax" id="m_fax" class="adm_inptext"  />
                     </td>
                  </tr><?php */?>
                  <tr>
                  ...
                  <tr>
                    <td width="20%">Designation</td><td>
                      <input type="text" name="m_designation" id="m_designation" class="adm_inptext"  />
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <input type="submit" class="ubutton" name="upload_kym" value="Save"  onclick="return(validate());"/>&nbsp;&nbsp;&nbsp;
