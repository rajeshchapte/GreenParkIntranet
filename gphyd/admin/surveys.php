          ...
          <table width="100%" border="0" cellspacing="8" cellpadding="0">        
            ...
            <tr>
              ...
              <td width="76%" valign="top" class="admin_content_area">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <?php
						  $select_surveys = mysql_query("SELECT * FROM survey_poll WHERE prp_code = '$prp_id' ORDER BY ID DESC");
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td style="font-size:12px;" align="left">
                                      Categories:  <a href="survey_cats.php?sid=<?=$get_surveys[id];?>"><strong><?php echo get_survey_cats_count($get_surveys[id]); ?></strong> [ View ]</a>&nbsp;&nbsp;&nbsp;
                                      Questions:  <a href="survey_questions.php?sid=<?=$get_surveys[id];?>"><strong><?php echo get_survey_questions($get_surveys[id]); ?></strong> [ View ]</a>&nbsp;&nbsp;&nbsp;
                                      
                                      Participants: <strong><?php echo get_survey_participants($get_surveys[id], $select_user_res[id], $prp_id); ?></strong>
                                    </td>
