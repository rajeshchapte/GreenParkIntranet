...
while($get_survey_scale = mysql_fetch_array($sel_survey_scale))
{
	...
	$select_survey_poll = mysql_query("SELECT COUNT(survey_answer_id) FROM survey_polls_by_employee WHERE survey_answer_id = $get_survey_scale[id] AND survey_id = '$sid' AND prp_code = '$prp_id'");
