...
$rsid = $_GET[rsid];
$sel_rs = mysql_query("SELECT * FROM record_sales_fbservices_gph WHERE id  = '$rsid'");
...
if(isset($_REQUEST[upload_nrs])){
	...
	if($record_sale_type == 'Revenue'){
		...
		$covers_record = NULL;
						...
						$nrs_save = mysql_query("UPDATE  record_sales_fbservices_gph SET `for_m_or_d` =  '$for_m_or_d',
													 `recrds_date` =  '$record_date',
													 `record_sale_type` =  '$record_sale_type', 
													 `fb_servcat_id` = '$fb_servcat_id',
													 `fb_serv_record_amount` = '$fb_serv_record_amount',
		...
		$covers_record = $_POST[fb_serv_covers_record];
						...
						$nrs_save = mysql_query("UPDATE  record_sales_fbservices_gph SET `for_m_or_d` =  '$for_m_or_d',
													 ...
													 `record_sale_type` =  '$record_sale_type', 
													 `fb_servcat_id` = '$fb_servcat_id',													 
													 `covers_record` = '$covers_record' WHERE id = '$rsid';");
                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <select name="record_sale_type" id="thechoices1" class="adm_select" style="width:263px">
                      <option value="Revenue" <?php echo $sel_rs_res[record_sale_type] == 'Revenue' ? 'selected' : null?>>Revenue</option>
                      <option value="Covers" <?php echo $sel_rs_res[record_sale_type] == 'Covers' ? 'selected' : null?>>Covers</option>
                    </select>
                    </td>
                  </tr>
                  <tr>
                   ...
                   <td>
                      <div style="float:left">
                        ...
                        ?>  
                        <option value="<?=$fbservcats_res[id]?>" <?php echo $sel_rs_res[fb_servcat_id] == $fbservcats_res[id] ? 'selected' : null?>><?=$fbservcats_res[fb_serivces_cat_name]?></option>
                        <?php } ?>
                        </select></div>
                        <div style="float:left">&nbsp;&nbsp;&nbsp;<a href="create_fbservcat.php?purl=<?=$_SERVER['REQUEST_URI'];?>"><img src="images/add_icon.png" width="25" align="Create New Department" title="Create New Department"   /></a>
                       </div>
                  ...
                  <tr>
                    ...
                    <div id="boxes">
                            <div id="Revenue">
                              ...
                              <input type="text" name="fb_serv_record_amount" id="fb_serv_record_amount" class="adm_inptext" value="<?=$sel_rs_res[fb_serv_record_amount]?>"  />&nbsp;&nbsp;
                              ...
                              <option value="&#37;" <?php echo $sel_rs_res[record_sale_type] == '%' ? 'selected' : null?>>&#37;</option>
                              <option value="Numbers" <?php echo $sel_rs_res[record_sale_type] == 'Numbers' ? 'selected' : null?>>Numbers</option>
                              </select>
                            </div>
                            <div id="Covers">
                                <input type="text" name="fb_serv_covers_record" id="fb_serv_covers_record" class="adm_inptext" value="<?=$sel_rs_res[covers_record]?>"  />
                            </div>
                      </div>
