...
$select_survey_q = mysql_query("SELECT * FROM survey_questions WHERE survey_id = '$sid' AND id = '$qid'");
$select_survey_qres = mysql_fetch_array($select_survey_q);
?>
            ...
            <tr>
              ...
              <td width="76%" valign="top" class="admin_content_area">
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><h2>Surveys Question Details</h2></td>
                      </tr>
                    </table>
                            ...
                            <tr>
                              <td style="background-color:#FFF; border:1px solid #999; padding:5px;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                  <tr>
                                    <td colspan="2">
                                    <a href="survey_question_details.php?sid=<?=$sid;?>&qid=<?=$qid;?>"><?=$select_survey_qres[survey_question_text];?></a>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td colspan="2">
                                  ...
                                  <tr>
                                    ...
                                    <div style="width:100%; position:relative;"><?php include("survey_chart_div_q.php"); ?></div>
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td align="right" style="font-size:12px;">
                                      <a href="add_new_question.php?sid=<?=$get_surveys[id];?>">Add New Question</a> - <a href="edit_survey_question.php?sid=<?=$sid;?>&sqid=<?=$qid;?>&edit_sq=Edit">Edit</a>
                                    </td>
                                  </tr>
                                </table>
