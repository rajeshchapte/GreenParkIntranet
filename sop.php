      ...
      <div class="col4 clearfix" style="background-color:#003e00; padding:16px 0px 0px 0px; margin:0px;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<td width="100%"  height="136">
                            <li class="tile tile-dsmall slideTextLeft" data-page-type="no" data-page-name="no"  onclick="location.href='documented_sop.php';">
                                <div style="background-color:#009e77; color:#FFFFFF;" class="tiletextfont">
                                    <p style="font-size:18px;">Documented SOP's</p>
                                </div>
                                <div style="background-color:#009e77; color:#FFFFFF;">
                                    <p><span class=""><img src="images/pdf_icon.png"  width="90" /></span></p>
                                </div>
                            </li>
                            <li class="tile tile-dsmall slideTextLeft" data-page-type="no" data-page-name="no" onclick="location.href='animated_sop.php';">
                                <div style="background-color:#009e77; color:#FFFFFF;" class="tiletextfont">
                                    <p style="font-size:18px;">Animated SOP's</p>
                                </div>
                                <div style="background-color:#009e77; color:#FFFFFF;">
                                    <p><span class=""><img src="images/pdf_icon.png"  width="90" /></span></p>
                                </div>
